...
-- role 'user' sengaja tidak diberi permission apa pun. -- --------------------------------------------------------------- -- Kunci column role pada users agar hanya berisi role yang dikenal. -- Sebelumnya column ini VARCHAR biasa: apa pun bisa masuk. -- --------------------------------------------------------------- 
UPDATE
    users
SET
    role = 'user'
...
ALTER TABLE
    users DROP CONSTRAINT IF EXISTS users_role_fkey;
