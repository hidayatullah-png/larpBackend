...
// Nilai 12 adalah kompromi yang lazim: cukup lambat bagi penyerang, masih cukup cepat untuk sekali login.
const bcryptCost = 12
...
// VerifyDummyPassword sengaja membuang waktu seperti VerifyPassword, dipakai ketika username tidak ditemukan.
...
// bcrypt tidak dipakai di sini karena token sudah acak dan panjang, sehingga tidak perlu diperlambat seperti password buatan manusia.
